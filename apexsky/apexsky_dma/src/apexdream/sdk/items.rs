...
pub enum WeaponName {
    ...
    EVA8 = hash("mp_weapon_shotgun"),
    EVA8_CRATE = hash("mp_weapon_shotgun_crate"),
    FLATLINE = hash("mp_weapon_vinson"),
    G7_SCOUT = hash("mp_weapon_g2"),
    HEMLOK = hash("mp_weapon_hemlok"),
    HEMLOK_CRATE = hash("mp_weapon_hemlok_crate"),
    KRABER = hash("mp_weapon_sniper"),
    LSTAR = hash("mp_weapon_lstar"),
    LSTAR_CRATE = hash("mp_weapon_lstar_crate"),
    MASTIFF = hash("mp_weapon_mastiff"),
    MOZAMBIQUE = hash("mp_weapon_shotgun_pistol"),
    MOZAMBIQUE_LIGHT = hash("mp_weapon_shotgun_pistol_light"),
    MOZAMBIQUE_ENERGY = hash("mp_weapon_shotgun_pistol_energy"),
    MOZAMBIQUE_SNIPER = hash("mp_weapon_shotgun_pistol_sniper"),
    MOZAMBIQUE_HEAVY = hash("mp_weapon_shotgun_pistol_heavy"),
    PROWLER = hash("mp_weapon_pdw"),
    PROWLER_CRATE = hash("mp_weapon_pdw_crate"),
    PEACEKEEPER = hash("mp_weapon_energy_shotgun"),
    R99 = hash("mp_weapon_r97"),
    R99_CRATE = hash("mp_weapon_r97_crate"),
    ...
    WINGMAN_CRATE = hash("mp_weapon_wingman_crate"),
    VOLT = hash("mp_weapon_volt_smg"),
    _3030_REPEATER = hash("mp_weapon_3030"),
...
pub fn ammo_type(weapon_name: WeaponName) -> ItemId {
    match weapon_name {
        ...
        WeaponName::BOCEK_BOW => ItemId::Arrows,
        ...
        WeaponName::EVA8 => ItemId::ShotgunShells,
        ...
        WeaponName::_3030_REPEATER => ItemId::HeavyRounds,
