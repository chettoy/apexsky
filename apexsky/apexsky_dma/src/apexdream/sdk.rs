...
pub const GAMEMODE_SURVIVAL: u32 = crate::apexdream::base::hash("survival");
pub const GAMEMODE_ARENAS: u32 = crate::apexdream::base::hash("arenas");
pub const GAMEMODE_CONTROL: u32 = crate::apexdream::base::hash("control");
pub const GAMEMODE_FREEDM: u32 = crate::apexdream::base::hash("freedm");
