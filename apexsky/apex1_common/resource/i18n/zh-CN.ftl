...
info-weapon-model-glow =
    ...
    被队友观战时 => 绿色
    被他人观战时 => 红色
menu-item-toggle-esp-service = 外部ESP服务
menu-value-esp-service-off = 关闭
menu-value-esp-service-on = 启动
...
loot-dual-shell = 双弹装填器
loot-kinetic-feeder = 动能供弹器
loot-quickdraw-holster = 快捷枪套
loot-selectfire-receiver = 选择射击模式接收器
loot-gun-shield-generator = 炮机
...
menu-item-players-menu = 记仇
players-menu-title = 玩家菜单
players-section = 玩家列表
menu-item-shotgun-auto-shot = 霰弹枪扳机
menu-item-super-grapple = 超级钩
menu-item-auto-tapstrafe = 自动TS
menu-item-aimbot-on-ads = 开镜自瞄
menu-item-aimbot-on-fire = 开火自瞄
menu-item-triggerbot-smooth = 自动扳机平滑度
menu-item-glow-features = 发光选项
