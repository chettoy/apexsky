...
pub fn skynade_angle(
    ...
    const WEAP_ID_THERMITE_GRENADE: u32 = crate::data::WeaponId::GrenadeThermite.0 as u32;
    const WEAP_ID_FRAG_GRENADE: u32 = crate::data::WeaponId::GrenadeFrag.0 as u32;
    const WEAP_ID_ARC_STAR: u32 = crate::data::WeaponId::GrenadeArcStar.0 as u32;
    ...
    trace!(dx, dy, v0, g);
    let launch_pitch = calc_angle(dx, dy, v0, g)?;
